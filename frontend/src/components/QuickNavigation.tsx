      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Navigation Panel */}
            <motion.div
              className="fixed bottom-24 right-6 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden"
